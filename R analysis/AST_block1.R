...
# Sample table
metadata <- read.csv("~/scratch/AST/metadataBlock1.csv")
...
SNPs <- filter_SNPs("~/scratch/AST/ANALYSIS_SETS/Block1_SNPs_for_Analysis_Sorted.bed",
                    transcripts,filterlist)

# Save output
write.csv(SNPs,"~/scratch/AST/ANALYSIS/INTERMEDIATE/Block1_SNPs.csv",row.names=F)
...
make_ASE_counts_matrix <- function(DIR_COUNTS,cores,SNPs){
  ...
  DIR_COUNTS="~/scratch/AST/COUNT/BLOCK1"
  cores=4
  # Read in data
...
# Execute function
SNP_counts <- make_ASE_counts_matrix("~/scratch/AST/COUNT/BLOCK1",4,SNPs)
...
# Save output
write.csv(SNP_counts,"~/scratch/AST/ANALYSIS/INTERMEDIATE/Block1_SNP_gene_counts.csv")
...
# Save output
write.csv(SNP_counts_normalized,"~/scratch/AST/ANALYSIS/INTERMEDIATE/Block1_SNP_gene_counts_normalized.csv")
...
# Save output
write.csv(GN_counts_normalized,"~/scratch/AST/ANALYSIS/INTERMEDIATE/Block1_GN_counts_normalized.csv")
write.csv(GN_counts,"~/scratch/AST/ANALYSIS/INTERMEDIATE/Block1_GN_counts.csv")
write.csv(BN_counts_normalized,"~/scratch/AST/ANALYSIS/INTERMEDIATE/Block1_BN_counts_normalized.csv")
write.csv(BN_counts,"~/scratch/AST/ANALYSIS/INTERMEDIATE/Block1_BN_counts.csv")
...
# Save output
write.csv(GN.GLIMMIX,"~/scratch/AST/ANALYSIS/RESULTS/Block1_GNGLIMMIX.csv", row.names=F)
write.csv(BN.GLIMMIX,"~/scratch/AST/ANALYSIS/RESULTS/Block1_BNGLIMMIX.csv", row.names=F)
...
# Save output
write.csv(GN.plot,"~/scratch/AST/ANALYSIS/RESULTS/Block1_GNAST.csv",row.names=F)
write.csv(BN.plot,"~/scratch/AST/ANALYSIS/RESULTS/Block1_BNAST.csv",row.names=F)
...
# Save output
write.csv(GN.collapse,"~/scratch/AST/ANALYSIS/RESULTS/Block1_GNAST_collapse.csv",row.names=F)
write.csv(BN.collapse,"~/scratch/AST/ANALYSIS/RESULTS/Block1_BNAST_collapse.csv",row.names=F)
...
fig1 <- arrangeGrob(GN.scatter, chisq.table, BN.scatter, widths=c(5,2.5,5))
plot(fig1)
